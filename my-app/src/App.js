...
//           <h1 className="text-4xl font-bold text-white">MovieHub</h1>
...
//       <div className="max-w-sm mx-auto mt-10 rounded-2xl border border-blue-200
...
//         <span className="mt-4 inline-block rounded-full bg-pink-300 px-3 py-1
//                    text-sm font-semibold text-black-400">Sci-Fi</span>
//         <button className="mx-auto block rounded-lg bg-cyan-600 px-4 py-2 font-semibold text-white
